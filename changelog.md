...
- Added compatibility between [Just Enough Breeding](https://www.curseforge.com/minecraft/mc-mods/justenoughbreeding) and [Let Fish Love](https://www.curseforge.com/minecraft/mc-mods/let-fish-love) + [Let More Fish Love](https://www.curseforge.com/minecraft/mc-mods/letmorefishlove)
...
- Added Roe Blini (for [Let Fish Love](https://www.curseforge.com/minecraft/mc-mods/let-fish-love) and [Brewin' and Chewin'](https://www.curseforge.com/minecraft/mc-mods/brewin-and-chewin))
  - Provides Corrosion II for 0:20 with [Collector's Reap](https://www.curseforge.com/minecraft/mc-mods/collectors-reap)
- Added Salmon and Roe Blini (for [Let Fish Love](https://www.curseforge.com/minecraft/mc-mods/let-fish-love) and [Brewin' and Chewin'](https://www.curseforge.com/minecraft/mc-mods/brewin-and-chewin))
  - Provides Corrosion II for 0:20 with [Collector's Reap](https://www.curseforge.com/minecraft/mc-mods/collectors-reap)
...
- Ender Nectar is now upgraded from Matcha Latte
  - Will be fermented in a Keg with [Brewin' and Chewin'](https://www.curseforge.com/minecraft/mc-mods/brewin-and-chewin)
    - Also provides Tipsy I for 2:00 and Intoxication I for 1:30
...
- Acorn can now be acquired by breaking the Leaves or cutting the Saplings of:
  - Flowering Oak trees from [Biomes O' Plenty](https://www.curseforge.com/minecraft/mc-mods/biomes-o-plenty)
  - Pale Oak trees from [Vanilla Backport](https://www.curseforge.com/minecraft/mc-mods/vanillabackport)
...
- Slightly improved placeability of compat pies
...
- Fixed Pie Crust recipe from `#forge:flour` requiring 2 instead of 3 (closes [#135](https://github.com/brnbrd/Delightful/issues/135))
...
- Added more flower cutting recipes for [Oh The Biomes We've Gone](https://www.curseforge.com/minecraft/mc-mods/oh-the-biomes-weve-gone)
...
- Added some models for [Environmental](https://www.curseforge.com/minecraft/mc-mods/environmental)
...
- Placeable Passion Fruit Tart, added Passion Fruit Tart Slice (for [Atmospheric](https://www.curseforge.com/minecraft/mc-mods/atmospheric))
  - Retexture of Mulberry Pie and Passion Fruit Tart available in `Delightful Overhauls` built-in resource pack
