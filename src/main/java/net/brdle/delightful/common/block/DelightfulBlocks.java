...
public class DelightfulBlocks {
    ...
    public static final RegistryObject<Block> QUARTZ_CABINET = registerBlock("quartz_cabinet", () -> new CabinetBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(0.8F).sound(SoundType.STONE)));
