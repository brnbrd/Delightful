...
public class FieryKnifeItem extends CompatKnifeItem {
  public FieryKnifeItem(Properties properties) {
    super("twilightforest", Util.it("forge", "ingots/fiery"), DelightfulTiers.FIERY, properties, new TranslatableComponent("item.twilightforest.fiery_sword.tooltip").withStyle(ChatFormatting.GRAY), null, ChatFormatting.YELLOW);
  }
