...
public class DelightfulWildCropGeneration extends WildCropGeneration {
	...
	public static void registerWildCropGeneration() {
		...
		FEATURE_PATCH_CANTALOUPE = register(new ResourceLocation(Delightful.MODID, "patch_cantaloupe"),
		...
		PATCH_CANTALOUPE = registerPlacement(new ResourceLocation(Delightful.MODID, "patch_cantaloupe"),
