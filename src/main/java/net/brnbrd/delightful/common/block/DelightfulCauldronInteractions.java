...
public class DelightfulCauldronInteractions {
	public static BlueprintCauldronInteraction MATCHA_MILKSHAKE = BlueprintCauldronInteraction.register(Util.delight("matcha_milkshake"), CauldronInteraction.newInteractionMap());
	public static BlueprintCauldronInteraction SALMONBERRY_MILKSHAKE = BlueprintCauldronInteraction.register(Util.delight("salmonberry_milkshake"), CauldronInteraction.newInteractionMap());
	public static BlueprintCauldronInteraction SOURCE_BERRY_MILKSHAKE = BlueprintCauldronInteraction.register(Util.delight("source_berry_milkshake"), CauldronInteraction.newInteractionMap());
