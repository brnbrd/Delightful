...
public class DelightfulItems {
    ...
    public static final RegistryObject<Item> LAVENDER_TEA = registerItem("lavender_tea", () -> new CaffeinatedItem((new Item.Properties()).tab(FarmersDelight.CREATIVE_TAB).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16), ModEffects.COMFORT, 100, 0, 2.0F, 1));
    public static final RegistryObject<Item> AZALEA_TEA = registerItem("azalea_tea", () -> new CaffeinatedItem((new Item.Properties()).tab(FarmersDelight.CREATIVE_TAB).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16), ModEffects.COMFORT, 100, 0, 2.0F, 1));
