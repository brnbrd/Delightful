...
public class DelightfulItemTags {
	...
	public static final TagKey<Item> CARAMEL = forge("caramel");
	...
	public static final TagKey<Item> BATTER = forge("batter");
	public static final TagKey<Item> PANCAKES = forge("pancakes");
